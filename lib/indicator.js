...
class ClippoIndicator extends PanelMenu.Button {
    _init(onActivate) {
        ...
        // The second argument is the panel button's accessible name (read by Orca).
        super._init(0.0, _('Clipboard history'), true);
        ...
        // Keyboard activation (the top bar is reachable via Ctrl+Alt+Tab):
        // without a menu, PanelMenu.Button does nothing on Enter/Space itself.
